        ...
        render={({ state, fullpageApi }) => {
          return (
            <ReactFullpage.Wrapper>
                ...
                <div className="  hero">
                  ...
                  <div className=" text-center">
                    <div className="max-w-md">
                      <h1 className="text-4xl font-bold sm:text-xl md:text-7xl lg:text-7xl">
                        Finn Jefferis
                      </h1>
                      <p className="py-6 text-l sm:text-xl md:text-2xl">
                        {' '}
                      ...
                      <a
                        ...
                        className="btn btn-outline btn-primary w-48 md:w-56 lg:w-64"
                      >
                        Github
                      </a>
                    </div>
              ...
              <div className="section ">
                <div className="text-center ">
                  <p className="text-5xl font-semibold  text-accent absolute top-5 left-5 underline">
                    Why me?
                  </p>
                  <p>
                  Responsive
                  ...
                  <p>
                 Mobile-first ensures that your website targets the devices your customers love.
                  </p>
                  <p>
                Cutting-edge technologies to ensure your website is competitive on the modern web.
                  </p>
                  <p>
                  No bloat
                  </p>
              ...
              <div className="section">
              <div className="text-5xl font-semibold  text-accent absolute top-5 left-5 underline">
                  Get in touch
                </div>
